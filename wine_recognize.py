...
def model1(i):
    ...
    if i > 5:
        i = i % 5
    train_file = './data/model1_data/wine_'+str(i)+'_data.csv'
    j = i+1
    if j > 5:
        j = j % 5
    test_file = './data/model1_data/wine_'+str(j)+'_data.csv'
    model1_file = './modfile/model1file/mlp'+str(i)+'.best_model.h5'
    model2_file = './modfile/model2file/mlp.best_model.h5'
    result_file = './data/err_data/wine_'+str(i)+'_data.csv'
    data2_path = './data/model2_data/wine_'+str(i)+'_data.csv'
...
def model2(i):
    results_flag = True
    data_path = './data/model2_data/wine_'+str(i)+'_data.csv'
