...
def generate_model2_data(model_name, datafile, model_file, testfile, result_path, batch_size):
    y1_test = generate_result(model_name=model_name, datafile=datafile + "1.pkl", model_file=model_file + "0.pkl",
                              testfile=testfile, batch_size=batch_size)
    y2_test = generate_result(model_name=model_name, datafile=datafile + "2.pkl", model_file=model_file + "1.pkl",
                              testfile=testfile, batch_size=batch_size)
    y3_test = generate_result(model_name=model_name, datafile=datafile + "3.pkl", model_file=model_file + "2.pkl",
                              testfile=testfile, batch_size=batch_size)
    y4_test = generate_result(model_name=model_name, datafile=datafile + "4.pkl", model_file=model_file + "3.pkl",
                              testfile=testfile, batch_size=batch_size)
    y5_test = generate_result(model_name=model_name, datafile=datafile + "5.pkl", model_file=model_file + "4.pkl",
                              testfile=testfile, batch_size=batch_size)
